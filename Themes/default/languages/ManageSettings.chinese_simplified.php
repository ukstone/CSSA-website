...
$txt['allow_disableAnnounce'] = '允许用户禁用公告';
$txt['disallow_sendBody'] = '不允许通过邮件接收回复';
$txt['queryless_urls'] = '搜寻引撆的友善网址(SEF URLs)<div class="smalltext"><strong>限 Apache/Lighttpd!</strong></div>';
$txt['max_image_width'] = '文章图片最大宽度（0=不限）';
$txt['max_image_height'] = '文章图片最大高度（0=不限)';
...
$txt['compactTopicPagesEnable'] = '页数显示最大数量';
$txt['contiguous_page_display'] = '连续显示页数';
$txt['to_display'] = '会显示';
$txt['todayMod'] = '启用简短日期';
