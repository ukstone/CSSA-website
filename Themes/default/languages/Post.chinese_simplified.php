...
$txt['center'] = '置中';
$txt['hyperlink'] = '输入超连结';
$txt['insert_email'] = '输入 Email';
$txt['bbc_code'] = '输入代码';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['bbc_quote'] = '引用';
$txt['list'] = '项目清单';
$txt['list_unordered'] = '插入无序列表(符号)';
$txt['list_ordered'] = '插入有序列表(编号)';

$txt['change_color'] = '选择颜色';
$txt['black'] = '黑色';
$txt['red'] = '红色';
$txt['yellow'] = '黄色';
$txt['pink'] = '粉红';
...
$txt['thumbs_up'] = '推';
$txt['thumbs_down'] = '嘘';
$txt['excamation_point'] = '惊叹号';
$txt['question_mark'] = '问号';
$txt['lamp'] = '灯泡';
$txt['add_smileys'] = '加入表情符号';
$txt['flash'] = '嵌入Flash(输入连结)';
$txt['ftp'] = 'ftp 连结';
$txt['image'] = '嵌入图片(输入连结)';
$txt['table'] = '插入表格';
$txt['table_td'] = '输入表格栏';
...
$txt['glow'] = '发光';
$txt['shadow'] = '阴影';
$txt['preformatted'] = '格式化文字';
$txt['left_align'] = '靠左对齐';
$txt['right_align'] = '靠右对齐';
$txt['superscript'] = '上标';
$txt['subscript'] = '下标';
$txt['table_tr'] = '插入一列';
$txt['post_too_long'] = '您的帖子内容过长, 请稍微减少帖子字数。';
$txt['horizontal_rule'] = '水平线';
$txt['font_size'] = '文字大小';
$txt['font_face'] = '字形';
$txt['toggle_view'] = '切换编辑器';
$txt['unformat_text'] = '移除格式';

$txt['rich_edit_wont_work'] = '您的浏览器不支援所见即所得编辑器。';
$txt['rich_edit_function_disabled'] = '您的浏览器不支援这个功能。';
...
$txt['lock_topic'] = '封锁主题';
$txt['shortcuts'] = '快速键: Alt+S 直接发表帖子, Alt+P 预览帖子。';
$txt['shortcuts_firefox'] = '快速键: 按键 shift+alt+s 送出/发表 或 shift+alt+p 预览';
$txt['option'] = '选项';
...
$txt['attach_restrict_attachmentPostLimit'] = '档案总和大小的限制是 %1$dKB';
$txt['attach_restrict_attachmentSizeLimit'] = '单一档案大小的限制是 %1$dKB';
$txt['attach_restrict_attachmentNumPerPostLimit'] = '每篇帖子 %1$d';
$txt['attach_restrictions'] = '限制:';

$txt['post_additionalopt'] = '进阶选项(包含帖子状态和附件)...';
$txt['sticky_after'] = '置顶主题';
$txt['move_after2'] = '移动主题';
$txt['back_to_topic'] = '回到主题';
